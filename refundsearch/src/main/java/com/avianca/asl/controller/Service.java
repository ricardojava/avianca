...
public class Service {
	...
	public String refundsearch(@PathParam("token") String token,
		...
		rSearch.setToken(token);
		rSearch.setNumSoli(numSoli);
		rSearch.setTypeTicket(typeTicket);
		rSearch.setNumTicket(numTicket);
		
		
		String  msgRetunr = command.execute(rSearch);
