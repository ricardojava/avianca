...
public class Service {
	...
	@GET
	@Path("/refundstatuslist/{token}")
	@Produces(value = MediaType.APPLICATION_JSON)
	public String refundstatuslist(@PathParam("token") String token,@PathParam("numsolici") String numSolici,@PathParam("typeticket") String typeTicket){
		logger.debug(token);
		...
		String  serviceChannelList = command.execute(token,numSolici,typeTicket);
